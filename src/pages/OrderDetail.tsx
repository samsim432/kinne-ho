        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 space-y-4 shadow-2xs">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              Buyer has deposited delivery fee of Rs. {deliveryFee} into Escrow.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-[11px] text-gray-500 mt-1">
                You receive 100% of the item price + the full delivery charge upon handover.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-[11px] text-gray-500 mt-1">
                Ship via Pathao / Nepal Can Move. Delivery fee goes directly to the courier.
              </p>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-5 shadow-2xl relative">
            ...
            >
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center space-y-1 cursor-pointer hover:border-red-500">
                <Upload className="w-5 h-5 text-gray-400 mx-auto" />
                <span className="text-xs font-semibold text-gray-700 block">Upload Evidence Photos</span>
              </div>
